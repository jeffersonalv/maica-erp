...
public class Menu implements MDIController, LoginController {
    ...
    public String getMDIFrameTitle() {
        ...
        /*Session session = null;
         ...
         EmpresaVO obj_Empresa = (EmpresaVO) session.get(EmpresaVO.class, 1);
    ...
    public String getAboutText() {
        return "Aplicação:  ERP\n"
                + "\n"
                + "The MIT License\n"
                + "Copyright: Copyright (C) 2011  ERP\n"
                + "\n"
    ...
    public boolean authenticateUser(Map loginInfo) throws Exception {
        ...
        // password =  Util.MD5String(nomeUsuario + password);
            ...
            try {
                ...
                if (MDIFrame.getSelectedFrame() != null) {
                    ...
                    if (!janela.endsWith("Grid")) {
                        JOptionPane.showMessageDialog(null, "Relatório não disponível para a janela selecionada.", "Informação do Sistema", JOptionPane.INFORMATION_MESSAGE);
                    } else {
                    ...
                    JOptionPane.showMessageDialog(null, "Nenhuma janela selecionada.", "Informação do Sistema", JOptionPane.INFORMATION_MESSAGE);
                }
            } catch (Exception ex) {
                //ex.printStackTrace();
